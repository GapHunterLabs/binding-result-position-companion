# Demo data — Binding Result Position Companion

For capturing the real Marketplace screenshot:

1. `./gradlew runIde`
2. Open `demo/OrderController.java` as a scratch/standalone file (or
   drop it into any sandbox project) inside the sandbox IDE.
3. The `@Valid` parameter shows the warning — hover it for the
   tooltip.
