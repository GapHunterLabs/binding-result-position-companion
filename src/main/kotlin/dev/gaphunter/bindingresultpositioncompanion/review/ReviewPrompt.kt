package dev.gaphunter.bindingresultpositioncompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.bindingresultpositioncompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.bindingresultpositioncompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Binding Result Position Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33896-binding-result-position-companion/reviews"
